...
_FOLDER_STATE_DEFS: dict[str, tuple[Optional[GradientClass], str]] = {
    ...
    # F2
    "FOLDER_VISIBLE": (
        GradientClass("background", "background", "background", "visible"),
        "default",
    ),
    # F3
    ...
    "FOLDER_MASKED_REVEALED": (
        GradientClass("masked", "revealed", "visible", "visible"),
        "default",
    ),
    # F6
    "FOLDER_MASKED_MIRRORED": (
        GradientClass("masked", "mirrored", "background", "background"),
        "default",
    ),
    # F7
    "FOLDER_REVEALED": (
...
_FILE_STATE_DEFS: dict[str, tuple[Optional[GradientClass], str]] = {
    ...
    # FI2
    "FILE_VISIBLE": (
        GradientClass("visible", "background", "background", "visible"),
        "default",
    ),
    # FI3
    "FILE_MASKED": (
