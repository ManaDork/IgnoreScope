...
- Mounts, masked, and revealed directories (inherited from LocalMountConfig)
...
class SiblingMount(LocalMountConfig):
    ...
    Inherits mounts/masked/revealed/pushed_files/mirrored from LocalMountConfig.
    ...
    Each sibling can have its own mounts, masked, revealed, and pushed_files,
    ...
    def to_dict(self) -> dict:
        ...
        Chains to super().to_dict() for mounts/masked/revealed/pushed_files,
