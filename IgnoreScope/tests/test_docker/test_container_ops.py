...
class TestLifecycleIsDockerInstalled:
    ...
    def test_docker_found(self):
        ...
        from IgnoreScopeDocker.docker.container_ops import is_docker_installed
...
class TestLifecycleIsDockerRunning:
    ...
    def test_running(self):
        ...
        from IgnoreScopeDocker.docker.container_ops import is_docker_running
...
class TestLifecycleGetContainerInfo:
    ...
    def test_returns_info_dict(self):
        ...
        from IgnoreScopeDocker.docker.container_ops import get_container_info
...
class TestLifecycleStartStop:
    ...
    def test_start_success(self):
        ...
        from IgnoreScopeDocker.docker.container_ops import start_container
    ...
    def test_stop_success(self):
        ...
        from IgnoreScopeDocker.docker.container_ops import stop_container
...
class TestLifecycleImageExists:
    ...
    def test_exists(self):
        ...
        from IgnoreScopeDocker.docker.container_ops import image_exists
...
class TestLifecycleVolumeExists:
    ...
    def test_exists(self):
        ...
        from IgnoreScopeDocker.docker.container_ops import volume_exists
...
class TestVolumeRemove:
    ...
    def test_remove_success(self):
        ...
        from IgnoreScopeDocker.docker.container_ops import remove_volume
...
class TestFileOpsContainerExists:
    ...
    def test_exists_via_inspect(self):
        ...
        from IgnoreScopeDocker.docker.container_ops import container_exists
...
class TestFileOpsPushFile:
    ...
    def test_push_success(self, tmp_path: Path):
        ...
        from IgnoreScopeDocker.docker.container_ops import push_file_to_container
    ...
    def test_push_directory_rejected(self, tmp_path: Path):
        """Returns (False, message) when path is a directory."""
        from IgnoreScopeDocker.docker.container_ops import push_file_to_container
...
class TestFileOpsPullFile:
    ...
    def test_pull_success(self, tmp_path: Path):
        ...
        """
        from IgnoreScopeDocker.docker.container_ops import pull_file_from_container
...
class TestFileOpsEnsureContainerRunning:
    ...
    def test_already_running(self):
        ...
        from IgnoreScopeDocker.docker.container_ops import ensure_container_running
...
class TestFileOpsEnsureContainerDirectories:
    ...
    def test_creates_directories(self):
        ...
        from IgnoreScopeDocker.docker.container_ops import ensure_container_directories
...
class TestFileOpsScanContainer:
    ...
    def test_scan_returns_files(self):
        ...
        from IgnoreScopeDocker.docker.container_ops import scan_container_directory
...
class TestFileOpsFileExistsInContainer:
    ...
    def test_file_exists(self):
        ...
        from IgnoreScopeDocker.docker.container_ops import file_exists_in_container
...
class TestFileOpsRemoveFile:
    ...
    def test_remove_success(self):
        ...
        from IgnoreScopeDocker.docker.container_ops import remove_file_from_container
...
class TestExecInContainer:
    ...
    def test_success_returns_stdout(self):
        ...
        from IgnoreScopeDocker.docker.container_ops import exec_in_container
...
class TestGetLlmCommand:
    ...
    def test_default_binary(self):
        ...
        from IgnoreScopeDocker.docker.container_ops import get_llm_command
...
class TestClaudeDeployerInstallCommands:
    ...
    def test_build_time_single_curl_command(self):
        ...
        from IgnoreScopeDocker.llm.claude import ClaudeDeployer
        from IgnoreScopeDocker.llm.deployer import DeployMethod
...
class TestImportContracts:
    ...
    def test_package_api_exports(self):
        ...
        import IgnoreScopeDocker.docker as docker_pkg
...
class TestSanitizeVolumeName:
    ...
    def test_space_to_underscore(self):
        ...
        from IgnoreScopeDocker.docker.names import sanitize_volume_name
...
class TestSanitizeScopeName:
    ...
    def test_preserves_case(self):
        ...
        from IgnoreScopeDocker.docker.names import sanitize_scope_name
