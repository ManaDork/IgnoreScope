"""Integration tests for IgnoreScopeDocker containers.
...
Or interactively: python -m IgnoreScopeDocker.tests.test_docker.test_integration
...
class TestMinimalContainer:
    ...
    def test_dockerfile_generation(self, temp_project: Path):
        ...
        from IgnoreScopeDocker.docker.compose import generate_dockerfile
    ...
    def test_compose_generation(self, temp_project: Path):
        ...
        from IgnoreScopeDocker.docker.compose import generate_compose_with_masks
    ...
    def test_container_lifecycle(
        ...
        from IgnoreScopeDocker.cli.commands import cmd_create, cmd_remove
...
class TestLLMContainer:
    ...
    def test_claude_dockerfile_generation(self, temp_project: Path):
        ...
        from IgnoreScopeDocker.docker.compose import generate_dockerfile_with_llm
        from IgnoreScopeDocker.llm import ClaudeDeployer
    ...
    def test_claude_deployer_interface(self):
        ...
        from IgnoreScopeDocker.llm import ClaudeDeployer, DeployMethod
    ...
    def test_claude_runtime_deployment(
        ...
        from IgnoreScopeDocker.core.config import ScopeDockerConfig
        from IgnoreScopeDocker.cli.commands import cmd_create, cmd_remove
        from IgnoreScopeDocker.llm import deploy_claude_npm, verify_claude
...
class TestFileOperations:
    ...
    def test_push_pull_cycle(
        ...
        from IgnoreScopeDocker.core.config import ScopeDockerConfig, get_container_path
        from IgnoreScopeDocker.cli.commands import cmd_create, cmd_push, cmd_pull, cmd_remove
...
def run_interactive_tests():
    ...
    print("\n" + "=" * 60)
    print("IgnoreScopeDocker Interactive Test Runner")
    print("=" * 60)
    ...
    while True:
        ...
        if choice == 'q':
            ...
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                from IgnoreScopeDocker.core.config import ScopeDockerConfig
                from IgnoreScopeDocker.cli.commands import cmd_create
