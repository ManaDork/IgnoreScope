...
| 9a | `scopeTree` | 96 | scope_view.py | QTreeView | parent | indentation 20px | hardcoded | Tree fills view; rows = project + sibling + extension auth stencil children of `MountDataTree.root_node` (see DATAFLOWCHART) |
